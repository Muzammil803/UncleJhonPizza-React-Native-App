...
<Text style={styles.headerPrice}>{sixePrice}</Text>

</View>
<Text style={{marginLeft:20, color:'rgba(255, 255, 255, 0.3)',fontSize:10}}>SIZE , CRUST , TOPPING</Text>
...
<Text style={styles.sizeText}>Choose your <Text style={{fontWeight:'bold'}}>size</Text></Text>
...
start={{ x: 1, y: 0 }}
 ...
 alignItems:'center',
    ...
    <Text onPress={()=>{setSmallStyleBox(true),setMediumStyleBox(null),setlargeStyleBox(null)}} style={{fontWeight:'bold',color:'white'}}>
        Small
         </Text> 
</LinearGradient>:
   <Text onPress={()=>{setSmallStyleBox(true),setMediumStyleBox(null),setlargeStyleBox(null),setSizePrice('$10.00')}} style={styles.sizeBtn}>Small</Text>
}
    </View>
   <View style={styles.sizeBtn}>
...
start={{ x: 1, y: 0 }}
 ...
 alignItems:'center',
    ...
    <Text onPress={()=>{setSmallStyleBox(null),setMediumStyleBox(true),setlargeStyleBox(null)}} style={{fontWeight:'bold',color:'white'}}>
        Medium
         </Text> 
</LinearGradient>:
   <Text onPress={()=>{setSmallStyleBox(null),setMediumStyleBox(true),setlargeStyleBox(null),setSizePrice('$12.00')}}
    style={styles.sizeBtn}>Medium</Text>
}
    </View>
    <View style={styles.sizeBtn}>
...
start={{ x: 1, y: 0 }}
 ...
 alignItems:'center',
    ...
    <Text onPress={()=>{setSmallStyleBox(null),setMediumStyleBox(null),setlargeStyleBox(true)}} style={{fontWeight:'bold',color:'white'}}>
        Large
         </Text> 
</LinearGradient>:
   <Text onPress={()=>{setSmallStyleBox(null),setMediumStyleBox(null),setlargeStyleBox(true),setSizePrice('$16.00')}} style={styles.sizeBtn}>Large</Text>
}
    </View>
</View>
</View>
